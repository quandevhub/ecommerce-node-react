    ...
    return (
        <>
            {products.map((product) => (
                <article key={product.id} className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm transition hover:shadow-md">
                    ...
                    <a><h3 className="mt-3 text-lg font-semibold text-gray-900 hover:text-gray-700">{product.name}</h3></a>
