        ...
        <header className="sticky top-0 z-20 border-b border-gray-700 bg-gray-800/95 px-4 py-3 text-white backdrop-blur">
            <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3">
                <div className="flex items-center gap-4">
                    <Link to="/" className="font-semibold hover:text-gray-300">Store</Link>
                    <Link to="/cart" className="inline-flex items-center gap-2 hover:text-gray-300">
                        Cart
                    ...
                    {token ? (
                        <>
                            <span className="text-sm text-gray-300">
                                Xin chào, <span className="font-medium text-white">{email}</span>
                            </span>
                            <button
                                type="button"
